...
require '../../backend/functions.php';
    ...
    $ubahBarang = query("SELECT*FROM tabel_barang WHERE id = $id")[0];

 
    // apakah tombol submit sudah di tekan / belum
if(isset($_POST["ubahBarang"])) {

    // apakah data berhasil di ubahBarang atau tidak
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                                <input type="hidden" name="id" value="<?= $ubahBarang["id"]; ?>">
                                <input type="hidden" name="gambarLama" value="<?= $ubahBarang["gambar"]; ?>">
                                
                            <div class="form-group">
                                <label for="nama" class="col-lg-2 col-sm-2 control-label" style="text-align: justify;">Nama Barang  </label>
                                <div class="col-lg-10">
                                    <input type="text" name="nama" required class="form-control" id="nama" placeholder="Masukkan Nama Barang Baru..." required value="<?= $ubahBarang["nama_barang"]; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="jumlah" class="col-lg-2 col-sm-2 control-label" style="text-align: justify;">Jumlah Barang  </label>
                                <div class="col-lg-10">
                                    <input type="text" name="jumlah" required class="form-control" id="jumlah" placeholder="Masukkan Jumlah Barang Baru..."  required value="<?= $ubahBarang["jumlah_barang"]; ?>">
                                </div>
                            </div>
                                 <div class="form-group">
                                <label for="harga" class="col-lg-2 col-sm-2 control-label" style="text-align: justify;">Harga Barang  </label>
                                <div class="col-lg-10">
                                    <input type="text" name="harga" required class="form-control" id="harga" placeholder="Masukkan Harga Barang Baru..."  required value="<?= $ubahBarang["harga_barang"]; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="stock" class="col-lg-2 col-sm-2 control-label" style="text-align: justify;">Stock Barang  </label>
                                <div class="col-lg-10">
                                    <input type="text" name="stock" required class="form-control" id="stock" placeholder="Masukkan Jumlah Stock Barang Baru..."  required value="<?= $ubahBarang["stock_barang"]; ?>">
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                <label for="status" class="col-lg-2 col-sm-2 control-label" style="text-align: justify;">Status Barang</label>
                                 <div class="col-lg-10">
                                    <select id="status" required class="form-control m-bot15" name="status"  required value="<?= $ubahBarang["staus_barang"]; ?>">
                                    <option>  Ready </option>
                            ...
                            <div class="form-group">
                                <label for="jenis" class="col-lg-2 col-sm-2 control-label" style="text-align: justify;">Jenis Barang</label>
                                 <div class="col-lg-10">
                                    <select id="jenis" required class="form-control m-bot15" name="jenis"  required value="<?= $ubahBarang["jenis_barang"]; ?>">
                                     <?php 
                            ...
                            <div class="form-group">
                                <label for="gender" class="col-lg-2 col-sm-2 control-label" style="text-align: justify;">Gender</label>
                                 <div class="col-lg-10">
                                    <select id="gender" class="form-control m-bot15" name="gender"  required value="<?= $ubahBarang["gender"]; ?>">
                                    <option> - </option>
                                    <option>  Pria </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" name="keterangan"  class="form-control" id="keterangan" placeholder="Masukkan Keterangan Baru..."  required value="<?= $ubahBarang["keterangan"]; ?>">
                                </div>
                            </div>
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <img src="images/<?= $ubahBarang["gambar"]; ?>" width="50">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button type="submit" name="ubahBarang"  class="btn btn-success btn-sm">Simpan</button> 
                                     <button type="reset" name="reset" value="bersihkan" class="btn btn-danger">Reset</button> 
                                </div>
                            </div>
                        </form>
                        </div>
