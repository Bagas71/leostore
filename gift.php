...
$hasilGift = query("SELECT  tabel_barang.id, tabel_barang.nama_barang, 
						...
						WHERE tabel_jenis_barang.jenis_barang IN ('Gift')");
 ?>
							...
							<div class="products-tabs">
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-1">
											 <?php foreach ($hasilGift as $gift) :?>
										<!-- product -->
										<div class="product">
											<div class="product-img">
												<img src="admin/frontend/data_input_barang/images/<?= $gift["gambar"]; ?>" alt="" width="30" height="200">
											</div>
											<div class="product-body">
												<p class="product-category"><?=$gift['nama_barang']; ?></p>
												<p class="product-available"><?=$gift['staus_barang']; ?></p>
												<h3 class="product-name"><a href="#"><?=$gift['jenis_barang']; ?></a></h3>
												<h4 class="product-price">Rp. <?= number_format($gift['harga_barang']);?> </h4>
												
												<div class="product-btns">
													<button class="quick-view"><a href="product.php?id=<?= $gift['id']; ?>"><i class="fa fa-eye"></i></a></i><span class="tooltipp">Lihat Produk</span></button>
												</div>
											</div>
											<div class="add-to-cart">
												<button class="add-to-cart-btn"><i class="fa fa-arrow-circle-right"></i><a href="checkout.php?id=<?= $gift['id']; ?>"> Checkout</a>
												</button>
											</div>		
										</div>
										<!-- /product -->
